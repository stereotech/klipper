...
class MCU_stepper:
    ...
    def set_position(self, coord):
        ...
        ffi_lib.itersolve_set_position(
            sk, coord[0], coord[1], coord[2], coord[3], coord[4])
        self._set_mcu_position(mcu_pos)
...
class PrinterRail:
    def __init__(self, config, need_position_minmax=True,
        ...
        self.endstops = []
        self.endstop_map = {}
        self.can_home = config.getboolean('can_home', True)
        ...
        if self.homing_positive_dir is None:
            ...
            elif self.position_endstop <= self.position_min + axis_len / 4.:
                self.homing_positive_dir = False
        ...
        if self.can_home:
            ...
            if endstop is None:
                ...
                if changed_invert or changed_pullup:
                    raise error("3024: Pinter rail %s shared endstop pin %s "
