...
void trapq_append(struct trapq *tq, double print_time,
                  ...
                  double start_pos_a, double start_pos_c, double axes_r_x,
                  double axes_r_y, double axes_r_z, double axes_r_a,
                  double axes_r_c, double start_v, double cruise_v, double accel);
