...
class CoreXY6AxisKinematics:
    ...
    def calc_position(self, stepper_positions):
        ...
        return [0.5 * (pos[0] + pos[1]), 0.5 * (pos[0] - pos[1]), pos[2], pos[3], pos[4], pos[5]]
    ...
    def check_move(self, move):
        ...
        if not move.axes_d[2] and not move.axes_d[3] and not move.axes_d[4] and not move.axes_d[5]:
...
def load_kinematics(toolhead, config):
    return CoreXY6AxisKinematics(toolhead, config)
